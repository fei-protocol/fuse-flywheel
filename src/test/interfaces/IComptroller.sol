...
interface Comptroller {
  ...
  function _setMarketSupplyCaps ( address[] memory cTokens, uint256[] memory newSupplyCaps ) external;
  ...
  function _setWhitelistStatuses ( address[] memory suppliers, bool[] memory statuses ) external returns ( uint256 );
